...
var serializer = module.exports = {
  ...
  serializeInt: function (buffer, size, value) {
    if (buffer.used + size > buffer.length) {
    ...
    switch (size) {
      // octet
      case 1:
        buffer[buffer.used++] = value;
        break;

      // short
      case 2:
        buffer[buffer.used++] = (value & 0xFF00) >> 8;
        buffer[buffer.used++] = (value & 0x00FF) >> 0;
        break;

      // long
      case 4:
        buffer[buffer.used++] = (value & 0xFF000000) >> 24;
        buffer[buffer.used++] = (value & 0x00FF0000) >> 16;
        buffer[buffer.used++] = (value & 0x0000FF00) >> 8;
        buffer[buffer.used++] = (value & 0x000000FF) >> 0;
        break;


      // long long
      case 8:
        buffer[buffer.used++] = (value & 0xFF00000000000000) >> 56;
        buffer[buffer.used++] = (value & 0x00FF000000000000) >> 48;
        buffer[buffer.used++] = (value & 0x0000FF0000000000) >> 40;
        buffer[buffer.used++] = (value & 0x000000FF00000000) >> 32;
        buffer[buffer.used++] = (value & 0x00000000FF000000) >> 24;
        buffer[buffer.used++] = (value & 0x0000000000FF0000) >> 16;
        buffer[buffer.used++] = (value & 0x000000000000FF00) >> 8;
        buffer[buffer.used++] = (value & 0x00000000000000FF) >> 0;
        break;
